...
--
-- Client: localhost
-- Généré le: Mar 03 Juin 2014 à 07:31
...
INSERT INTO `player` (`ID_Player`, `Pseudo`, `Password`, `Email`, `SubscribeDate`) VALUES
(1, 'Player1', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', NULL, NULL),
(3, 'Player2', '3da541559918a808c2402bba5012f6c60b27661c', 'asdf@asdf.asdf', NULL);
...
CREATE TABLE IF NOT EXISTS `stats` (
  ...
  UNIQUE KEY `FK_Player` (`ID_Player`),
  UNIQUE KEY `FK_Word` (`ID_Word`)
...
--
ALTER TABLE `stats`
  ADD CONSTRAINT `remove_word` FOREIGN KEY (`ID_Word`) REFERENCES `word` (`ID_Word`) ON DELETE CASCADE,
  ADD CONSTRAINT `remove_player` FOREIGN KEY (`ID_Player`) REFERENCES `player` (`ID_Player`) ON DELETE CASCADE;

--
-- Contraintes pour la table `word`
--
ALTER TABLE `word`
  ADD CONSTRAINT `category_remove` FOREIGN KEY (`ID_Category`) REFERENCES `category` (`ID_Category`) ON DELETE CASCADE;
