...
public class JListGame extends JFrame {
	...
	private JListGamePanel basePanel;
	private JGameInfoPanel infoPanel;
	...
	private void initialize() {
		...
		basePanel = new JListGamePanel();
		basePanel.setLayout(new BorderLayout());

		infoPanel = new JGameInfoPanel();
	...
	class JListGamePanel extends JPanel {
	...
	class JGameInfoPanel extends JPanel {
		...
		private void refreshGameInfo() {
			...
			if (selectetGame != null) {
				gameCreatorValue.setText(selectetGame.getCreator().getPseudo());
				gameCreatorValue.setToolTipText(gameCreatorValue.getText());

				if (selectetGame.isMode()) {
					gameModeValue.setText("Team game");
				} else {
					gameModeValue.setText("Solo game");
				}
				gameRoundValue.setText(String.valueOf(selectetGame.getNbRounds()));
				nbrPlayerValue.setText(String.valueOf(selectetGame.getNbMaxGamers()));
