...
//		categories= new JList<String>();
		...
		//just for testing I manually add a list
		...
		String testW[] = {"test","test2","Hello","test","Goos","Poney","Hey","word"};
		String testC[] = {"cat1","cat2","Animals","Cartoon"};
		words = new JList<String>(testW);
		categories= new JList<String>(testC);
